...
function IngredientModal({ mode, initialData, onClose, onSuccess }) {
  ...
  const [conversionFactor, setConversionFactor] = useState(
    initialData?.conversionFactor ?? "",
  );
  const [costPerStorageUnit, setCostPerStorageUnit] = useState(
    initialData?.costPerStorageUnit ?? "",
  );
  ...
  return (
    ...
    >
      <div
        className="max-h-[calc(100dvh-2rem)] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-lg"
