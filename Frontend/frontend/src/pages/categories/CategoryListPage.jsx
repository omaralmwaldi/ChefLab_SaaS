  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <p className="text-sm text-stone-500">{categories.length} Categor{categories.length === 1 ? "y" : "ies"}</p>
        <button
          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-stone-100 bg-stone-50">
                <th className="px-5 py-3 font-medium text-stone-500">SKU</th>
                <th className="px-5 py-3 font-medium text-stone-500">Name (English)</th>
                <th className="px-5 py-3 font-medium text-stone-500">الاسم (عربي)</th>
                <th className="px-5 py-3 font-medium text-stone-500">Created</th>
                <th className="px-5 py-3 font-medium text-stone-500">Actions</th>
              </tr>
            </thead>
            <tbody>
              {categories.map((cat) => (
                <tr key={cat.id} className="border-b border-stone-100 last:border-0 hover:bg-stone-50">
                  <td className="px-5 py-3.5 font-mono text-xs text-stone-600">{cat.sku}</td>
                  <td className="px-5 py-3.5 font-medium text-stone-800">{cat.nameEn}</td>
                  <td className="px-5 py-3.5 text-stone-700" dir="rtl">{cat.nameAr}</td>
