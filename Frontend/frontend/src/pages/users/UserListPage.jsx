        ...
        <div className="overflow-hidden rounded-xl bg-white shadow-sm">
          <ul className="divide-y divide-stone-100">
            {users.map((u) => {
              ...
              const viewerIsOwner = !!currentUser?.isOwner;
              // Owner record: only the owner may edit their own row; nobody may delete it.
              const canManageRow = !isOwnerRow || viewerIsOwner;
              const canDeleteRow = !isSelf && !isOwnerRow;
                ...
                <li key={u.id} className="flex items-center gap-4 px-4 py-3.5 transition-colors hover:bg-stone-50">
                  ...
                  <div className="flex shrink-0 items-center gap-1">
                    ...
                    <Can permission={PERMISSIONS.USERS_MANAGE}>
                      {!isOwnerRow && (
                      <button
                        onClick={() => canDeleteRow && setDeleteTarget(u)}
