...
const links = [
  ...
  { to: "/recipes", label: "Recipes", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
  { to: "/ingredients", label: "Ingredients", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
  { to: "/categories", label: "Categories", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
      ...
      <div className="border-t border-stone-700 px-4 py-4">
        <div className="mb-2 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-stone-500">{user?.role?.nameEn || "No role"}</p>
          </div>
        </div>
        <button
          onClick={logout}
